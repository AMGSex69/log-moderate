-- Исправление проблемы "Employee not found" и других SQL проблем
...
SELECT 
    ...
    CASE 
        ...
        WHEN user_id = '' THEN '❌ Пустой user_id'
        ELSE '✅ Корректный user_id'
    END as user_id_status
FROM employees 
WHERE user_id IS NULL OR user_id = '' OR LENGTH(user_id::text) < 30
ORDER BY id;
