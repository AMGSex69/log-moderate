	...
	return (
		<div className="space-y-6">
			...
			<div className="flex gap-2">
				<PixelButton variant={period === "day" ? "default" : "secondary"} size="sm" onClick={() => setPeriod("day")}>
					7 дней
				</PixelButton>
				<PixelButton variant={period === "week" ? "default" : "secondary"} size="sm" onClick={() => setPeriod("week")}>
					30 дней
				</PixelButton>
				<PixelButton
										...
										<div className="p-4">
											<div className="flex items-center justify-between">
												...
												<div className="text-right">
													<div className="flex items-center gap-2">
														<Trophy
															className={`h-5 w-5 ${task.rank_position === 1
																? "text-yellow-500"
